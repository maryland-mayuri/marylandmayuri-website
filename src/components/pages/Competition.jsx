          ...
          <div className="event-cards">
            <div className="event-card main-event fade-in">
              ...
              <button className="ticket-button">
                <a className="ticket-link" href="https://doorlist.app/e/ub5am90?s=hTtEk7nZf6&utm_source=ig&utm_medium=social&utm_content=link_in_bio&fbclid=PAZXh0bgNhZW0CMTEAc3J0YwZhcHBfaWQMMjU2MjgxMDQwNTU4AAGnkBBfLKiCzKcC1eXn2NzP2Qfz4Z9Vqp9Elc80L-JZYhwnWHmW6C6qRkNI7cY_aem_KJlhdcK7D_AYWAHI82AjAg" rel="noopener noreferrer">Buy Show Tickets</a>
              </button>
            </div>
{ 
            <div className="event-card afterparty">
              ...
              <p>1413 K St NW, Washington, DC 20005</p>
              <p>Doors open at 10:00 PM!</p>
              <button className="ticket-button">
                <a className="ticket-link" href="https://www.eventbrite.com/e/mayuri-afterparty-2026-presented-by-nitesout-maryland-mayuri-tickets-1980938246621?aff=erelexpmlt" target="_blank" rel="noopener noreferrer">Buy Afterparty Tickets</a>
              </button>
            </div> }
          </div>
